...
def template(
    ...
    def decorator(page_content: Callable[[], rx.Component],
                  state: rx.State) -> rx.Component:
        """The template for each page of the app.
        ...
        def templated_page():
            return rx.hstack(
                ...
                menu_button(),
                align="start",
                background=f"radial-gradient(circle at top right, {rx.color('teal', 2)}, {rx.color('mauve', 1)});",
                position="relative",
            )
